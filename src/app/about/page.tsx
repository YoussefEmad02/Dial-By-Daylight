...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16" data-section="company-image" id="company-image">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className={`text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-3 sm:mb-4 px-4 transition-all duration-1500 ${isSectionVisible('company-image') ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-100px]'}`}>
              Our Global Team
            </h2>
            <p className={`text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4 transition-all duration-1500 ${isSectionVisible('company-image') ? 'animate-slide-in-right' : 'opacity-0 translate-x-[100px]'}`}>
            ...
            <Card className={`group relative hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1500 ${isSectionVisible('mission-vision') ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-100px]'}`}>
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500/5 to-blue-600/5 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  ...
                  <div className="flex items-center mb-4 sm:mb-6">
                    ...
                    <h2 className="text-xl sm:text-2xl font-bold text-gray-900 group-hover:text-blue-600 transition-colors duration-500">Our Mission</h2>
                  </div>
                  <p className="text-gray-600 text-base sm:text-lg leading-relaxed group-hover:text-gray-700 transition-colors duration-500">
      ...
      <section className="py-20" data-section="our-edge" id="our-edge">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-3xl md:text-4xl font-bold text-gray-900 mb-4 transition-all duration-1500 ${isSectionVisible('our-edge') ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-100px]'}`}>Our Edge</h2>
            <p className={`text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed transition-all duration-1500 ${isSectionVisible('our-edge') ? 'animate-slide-in-right' : 'opacity-0 translate-x-[100px]'}`}>
              ...
              <Card key={index} className={`group relative text-center hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1500 ${isSectionVisible('our-edge') ? `animate-slide-in-${index % 2 === 0 ? 'left' : 'right'}` : `opacity-0 translate-x-[${index % 2 === 0 ? '-100px' : '100px'}]`}`}>
                ...
                <CardContent className="p-8 relative">
                    ...
                    <value.icon className="w-8 h-8 text-white" />
                                     ...
                                     <h3 className="text-xl font-semibold text-gray-900 mb-4 group-hover:text-gray-700 transition-colors duration-500">{value.title}</h3>
                   <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-500">{value.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
      ...
      {/* Our Process */}
      <section className="py-20 bg-gray-50" data-section="our-process" id="our-process">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-3xl md:text-4xl font-bold text-gray-900 mb-4 transition-all duration-1000 ${isSectionVisible('our-process') ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-100px]'}`}>Our Process</h2>
            <p className={`text-xl text-gray-600 max-w-3xl mx-auto transition-all duration-1000 ${isSectionVisible('our-process') ? 'animate-slide-in-right' : 'opacity-0 translate-x-[100px]'}`}>Every agent goes through a tight funnel to ensure quality delivery under pressure.</p>
          </div>
              ...
              <div key={index} className="relative">
                <Card className={`group relative text-center hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1000 ${isSectionVisible('our-process') ? `animate-slide-in-left-delay-${index}` : 'opacity-0 translate-x-[-100px]'}`}>
                  ...
                  <CardContent className="p-8 relative">
                    ...
                    <div className="text-sm font-bold text-blue-600 mb-2 group-hover:text-blue-700 transition-colors duration-300">STEP {step.step}</div>
                    <h3 className="text-lg font-semibold text-gray-900 group-hover:text-gray-700 transition-colors duration-300">{step.title}</h3>
                  </CardContent>
                </Card>
            ...
            <Card className={`group relative hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1000 ${isSectionVisible('client-operations') ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-100px]'}`}>
              ...
              <CardContent className="p-8 relative">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 group-hover:text-green-600 transition-colors duration-300">Client Focus</h2>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center group/item">
                    ...
                    <span className="text-gray-600 group-hover/item:text-gray-700 transition-colors duration-300">Real Estate</span>
                  </div>
                  <div className="flex items-center group/item">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3 group-hover/item:scale-110 transition-transform duration-300" />
                    <span className="text-gray-600 group-hover/item:text-gray-700 transition-colors duration-300">High-Ticket Services</span>
                  </div>
                  <div className="flex items-center group/item">
                    <CheckCircle className="w-5 h-5 text-green-500 mr-3 group-hover/item:scale-110 transition-transform duration-300" />
                    <span className="text-gray-600 group-hover/item:text-gray-700 transition-colors duration-300">B2B Lead Generation</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className={`group relative hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1000 ${isSectionVisible('client-operations') ? 'animate-slide-in-right' : 'opacity-0 translate-x-[100px]'}`}>
              ...
              <CardContent className="p-8 relative">
                <div className="flex items-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 group-hover:text-orange-600 transition-colors duration-300">Operational Excellence</h2>
                </div>
                <p className="text-gray-600 text-lg leading-relaxed mb-6 group-hover:text-gray-700 transition-colors duration-300">
                ...
                <div className="space-y-3">
                  <div className="flex items-center group/item">
                    ...
                    <span className="text-gray-600 group-hover/item:text-gray-700 transition-colors duration-300">Operations Management</span>
                  </div>
                  <div className="flex items-center group/item">
                    <CheckCircle className="w-5 h-5 text-orange-500 mr-3 group-hover/item:scale-110 transition-transform duration-300" />
                    <span className="text-gray-600 group-hover/item:text-gray-700 transition-colors duration-300">Recruitment & Training</span>
                  </div>
                  <div className="flex items-center group/item">
                    <CheckCircle className="w-5 h-5 text-orange-500 mr-3 group-hover/item:scale-110 transition-transform duration-300" />
                    <span className="text-gray-600 group-hover/item:text-gray-700 transition-colors duration-300">Payroll & Dialer Setup</span>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      {/* Company Stats */}
      <section className="py-20 bg-gradient-to-br from-gray-50 to-blue-50" data-section="company-stats" id="company-stats">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className={`text-3xl md:text-4xl font-bold text-gray-900 mb-4 transition-all duration-1000 ${isSectionVisible('company-stats') ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-100px]'}`}>
              Our Impact
            </h2>
            <p className={`text-xl text-gray-600 max-w-3xl mx-auto transition-all duration-1000 ${isSectionVisible('company-stats') ? 'animate-slide-in-right' : 'opacity-0 translate-x-[100px]'}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className={`group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 border border-gray-100 transition-all duration-1000 ${isSectionVisible('company-stats') ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-100px]'}`}>
              ...
              <div className="relative text-center">
                ...
                <div className="text-gray-600 group-hover:text-gray-700 transition-colors duration-300 font-medium">English Fluent Agents</div>
                <div className="text-sm text-gray-500 mt-2">Native-level communication</div>
              </div>
            </div>
            ...
            <div className={`group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 border border-gray-100 transition-all duration-1000 ${isSectionVisible('company-stats') ? 'animate-slide-in-right' : 'opacity-0 translate-x-[100px]'}`}>
              ...
              <div className="relative text-center">
                ...
                <div className="text-gray-600 group-hover:text-gray-700 transition-colors duration-300 font-medium">Operations Coverage</div>
                <div className="text-sm text-gray-500 mt-2">Round-the-clock support</div>
              </div>
            </div>
            ...
            <div className={`group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 border border-gray-100 transition-all duration-1000 ${isSectionVisible('company-stats') ? 'animate-slide-in-left' : 'opacity-0 translate-x-[-100px]'}`}>
              ...
              <div className="relative text-center">
                ...
                <div className="text-gray-600 group-hover:text-gray-700 transition-colors duration-300 font-medium">Industries Served</div>
                <div className="text-sm text-gray-500 mt-2">Diverse expertise</div>
              </div>
            </div>
            ...
            <div className={`group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transform hover:-translate-y-2 hover:scale-105 border border-gray-100 transition-all duration-1000 ${isSectionVisible('company-stats') ? 'animate-slide-in-right' : 'opacity-0 translate-x-[100px]'}`}>
              ...
              <div className="relative text-center">
                ...
                <div className="text-gray-600 group-hover:text-gray-700 transition-colors duration-300 font-medium">Setup & Deployment</div>
                <div className="text-sm text-gray-500 mt-2">Days, not months</div>
              </div>
            </div>
          </div>
        </div>
