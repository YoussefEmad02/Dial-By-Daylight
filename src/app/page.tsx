...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          >
            ...
            <span className="text-center sm:text-left">Cost-Effective Outbound Teams</span>
      ...
      <section className="py-20 bg-gray-50" data-section="services" id="services">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            <Card className={`group relative hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1500 ${
              isSectionVisible("services")
                ? "animate-slide-in-left"
                : "opacity-0 translate-x-[-100px]"
            }`}>
              ...
              <CardContent className="p-8 text-center relative">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 group-hover:text-gray-700 transition-colors duration-300">Digital Transformation</h3>
            ...
            <Card className={`group relative hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1500 ${
              ...
              <CardContent className="p-8 text-center relative">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 group-hover:text-gray-700 transition-colors duration-300">Business Consulting</h3>
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
            ...
            <Card className={`group relative hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1500 ${
              ...
              <CardContent className="p-8 text-center relative">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 group-hover:text-gray-700 transition-colors duration-300">Technology Solutions</h3>
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                  Custom software and technology solutions tailored to your needs.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20" data-section="why" id="why">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            <Card className={`group relative text-center hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1500 ${
              isSectionVisible("why")
                ? "animate-slide-in-left"
                : "opacity-0 translate-x-[-100px]"
            }`}>
              ...
              <CardContent className="p-8 relative">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 group-hover:text-gray-700 transition-colors duration-300">Expertise</h3>
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
            ...
            <Card className={`group relative text-center hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1500 ${
              ...
              <CardContent className="p-8 relative">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 group-hover:text-gray-700 transition-colors duration-300">Innovation</h3>
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
            ...
            <Card className={`group relative text-center hover:shadow-2xl transform hover:-translate-y-3 hover:scale-105 border-0 shadow-lg bg-white/90 backdrop-blur-sm transition-all duration-1500 ${
              ...
              <CardContent className="p-8 relative">
                ...
                <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 group-hover:text-gray-700 transition-colors duration-300">24/7 Support</h3>
                <p className="text-gray-600 text-sm sm:text-base leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
      ...
      <section className="py-20 bg-gray-50" data-section="carousel" id="carousel">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            className={`text-center mb-12 sm:mb-16 transition-all duration-1500 ${
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto">
              Explore how we've helped businesses transform and achieve their goals.
            </p>
          </div>
