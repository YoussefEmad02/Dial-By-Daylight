  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      isScrolled 
        ...
        : 'bg-gradient-to-r from-white/95 via-blue-50/95 to-indigo-50/95 backdrop-blur-sm'
    }`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="lg:hidden flex items-center space-x-2">
            <Button 
              ...
              className="relative p-2 hover:bg-blue-50 rounded-lg transition-colors duration-300"
            >
        ...
        {isOpen && (
          <div className="lg:hidden">
            <div className="px-4 pt-4 pb-6 space-y-2 bg-white/95 backdrop-blur-md border-t border-gray-200/50 rounded-b-2xl shadow-lg">
              {navLinks.map((link) => {
                const isActive = pathname === link.href
                return (
                  <Link
