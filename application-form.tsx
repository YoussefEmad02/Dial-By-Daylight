...
const applicationSchema = z.object({
  ...
  applicationSource: z.enum(["upwork", "linkedin", "facebook", "google", "wuzzuf", "bayt", "referral", "indeed"]).refine((val) => val !== undefined, {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <RadioGroup
                onValueChange={(value) => setValue("applicationSource", value as "upwork" | "linkedin" | "facebook" | "google" | "wuzzuf" | "bayt" | "referral" | "indeed")}
